        ...
        return (
            <div className="section">
                ...
                <Row>
                    ...
                    <Col md={3}>
                        <img style={{ width: "inherit" }} md={3} src={this.state.album.img} alt={this.state.album.albumName}>
                        </img>
                        <h4>{this.state.album.albumName}</h4>
                        <span >{this.state.album.singer[0]}</span>
                    </Col>
                    {/* Danh sach bai hat */}
                    <Col md={9} className="list-song-album-page">
                        <div>
